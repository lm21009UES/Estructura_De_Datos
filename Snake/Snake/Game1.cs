...
namespace Snake
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            logoUES = Content.Load<Texture2D>("minerva2");
        ...
        protected override void Update(GameTime gameTime)
        {
            if (GamePad.GetState(PlayerIndex.One).Buttons.Back == ButtonState.Pressed || Keyboard.GetState().IsKeyDown(Keys.Escape))
                Exit();
            //si se quiere llegar a un nivel mas rapido, solo se modifica el score en los if
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(fuente, "LM21009", new Vector2(20, 640), Color.Black);
            if (finJuego)
            {
            ...
            _spriteBatch.Draw(logoUES, new Rectangle(570, 1, 50,48), Color.White);
            _spriteBatch.End();
